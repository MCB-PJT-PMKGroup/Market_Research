...
from 
	cx.agg_CC_Taste_Switch_23Q4_24Q1 t
		join cx.fct_K7_Monthly a on a.id = t.id AND YYYYMM in ('202310', '202311', '202312', '202401', '202402', '202403') 
...
from 
	cx.agg_CC_Taste_Switch_23Q4_24Q1  t
		join cx.fct_K7_Monthly a on t.id = a.id and YYYYMM in ('202310', '202311', '202312', '202401', '202402', '202403')  
		join cx.product_master b on a.Product_code = b.prod_id and b.CIGADEVICE ='CIGARETTES' and b.CIGATYPE != 'CSV' 
			and not (t.FLAVORSEG_type3 = b.FLAVORSEG_type3 and t.cigatype = b.cigatype)
WHERE  t.cigatype ='HnB' and t.FLAVORSEG_type3 = 'Regular' 
...
group by
     t.FLAVORSEG_type3, t.cigatype,  c.quarterly
order by cigatype, FLAVORSEG_type3 , quarterly
;


-- Summary Total Taste 구매자, 구매팩수 카운트 (기본조건 제외)
select 
	b.FLAVORSEG_type3,
	b.cigatype,
	c.quarterly,
...
select 
	...
	sum(a.pack_qty) as Total_Pack_Cnt
FROM 
	cx.seven11_user_3month_list_tmp t
